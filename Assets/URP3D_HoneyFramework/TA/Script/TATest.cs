...
public class TATest : MonoBehaviour {
    ...
    [SerializeField, Range(5.0f, 100.0f)] private float radius = 10.0f;
    [SerializeField] private bool playAnim = false;
    [SerializeField] private float spdAnim = 1.0f;
    [SerializeField] private float radiusAnimMin = 5.0f;
    ...
    private void Update() {
        if (mat == null) {
            mat = plane?.GetComponent<MeshRenderer>().sharedMaterial;
        }
